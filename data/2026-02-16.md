...
Method: Analysis of central LSBGs and their satellite systems using the Illustris TNG-100 cosmological simulation, examining halo properties (spin, concentration), satellite spatial/kinematical distribution, number of satellites, velocity dispersion, and orbital characteristics.

Result: LSBGs have larger satellite numbers and higher velocity dispersion than HSBGs; continuous relation between satellite count and surface brightness; satellite systems in LSBGs are rotation-dominated and counter-rotate relative to the primary disc; LSBGs show correlation with fewer major mergers.

Conclusion: LSBG formation is linked to satellite systems with rotational dominance and counter-rotation, indicating these galaxies experienced fewer major mergers compared to HSBGs, supporting a merger-quiet formation pathway in ΛCDM.
...
TL;DR: SN feedback in compact star-forming galaxies may facilitate ionizing photon escape during reionization, with SN-hosting galaxies showing elevated SFRs, burstier star formation, bluer UV slopes, and lower ionizing photon production efficiency.


<details>
  <summary>Details</summary>
Motivation: To understand how supernova feedback enables ionizing photon escape in compact star-forming galaxies during cosmic reionization by studying low-redshift analogs (Green Pea and Blueberry galaxies).
...
Result: SN-hosting BBs show elevated SFRs, burstier recent star formation histories (~50 Myr), higher stellar masses, bluer UV slopes (2.1σ significance), and lower ionizing photon production efficiency (7.9σ significance). SN rate may be slightly suppressed compared to field galaxies.

Conclusion: SN-driven feedback may facilitate ionizing photon escape (supported by bluer UV slopes) but also potentially quenches ionizing photon production in compact star-forming galaxies during reionization, as indicated by lower production efficiency in SN hosts.
...
TL;DR: CenA and M83 are infalling toward each other like the Milky Way-Andromeda system, with a total mass of ~6.36×10¹² M☉ estimated using the Timing Argument calibrated with simulations.


<details>
  <summary>Details</summary>
Motivation: To determine whether Centaurus A and M83, despite their observed velocities suggesting otherwise, are actually gravitationally bound and infalling like the Milky Way-Andromeda system in the Local Group.

Method: Applied the Timing Argument (TA) calibrated with analog galaxy pairs from the AbacusSummit simulation, assuming line-of-sight velocity is dominated by motion toward the system's barycenter to estimate total mass.

Result: Estimated total mass of CenA/M83 system is (6.36 ± 1.30) × 10¹² M☉, consistent with independent virial mass and K-band luminosity-to-mass ratio estimates, confirming bound infall.

Conclusion: CenA and M83 form a gravitationally bound, infalling system analogous to the Local Group's Milky Way-Andromeda pair, with NGC 4945 potentially playing a perturbing role similar to the Large Magellanic Cloud.
...
TL;DR: The paper investigates why Centaurus A has fewer bright satellite galaxies in its inner regions than expected, finding that AGN feedback from the central galaxy's radio lobes likely quenched star formation in these satellites.


<details>
  <summary>Details</summary>
Motivation: To explain the puzzling deficit of luminous satellite galaxies in the inner regions (d<150 kpc) of Centaurus A, despite the overall satellite population matching theoretical expectations.

Method: Used the Galacticus semi-analytic model applied to high-resolution N-body merger trees, calibrated to the Milky Way, to investigate various quenching mechanisms including tidal disruption, reionization quenching, and suppressed accretion from the intergalactic medium.

Result: Fiducial models reproduce the overall Cen A satellite population but overpredict bright inner-halo satellites (Mv < -15.8) by factor 4±1. The spatial coincidence with Cen A's radio lobes suggests AGN-driven thermal feedback at z < 5 can significantly suppress star formation in satellites, truncating the bright end of the inner luminosity function.

Conclusion: The "Curious Case of Centaurus A" provides evidence that AGN feedback within the host galaxy regulates the survival and evolution of its dwarf galaxy satellites, explaining the deficit of bright satellites in the inner regions.
...
TL;DR: Dwarf spheroidal galaxy mass estimates are highly sensitive to assumptions about stellar density profiles, with systematic errors up to 10× when using standard methods.


<details>
  <summary>Details</summary>
Motivation: Standard dynamical mass estimators for dwarf spheroidal galaxies rely on assumptions about stellar density profiles that may not reflect actual structural diversity, potentially introducing large systematic errors in mass determinations.

Method: Fitting flexible stellar density models to Milky Way dSph observations, using virial theorem to propagate uncertainties in density profile shapes to dynamical mass estimates, considering various dark matter halo shapes and extents.

Result: The structural diversity of Milky Way dSphs implies potential systematic errors up to factors of 10 in standard dynamical mass estimators, significantly affecting scaling relations like enclosed dynamical mass vs. stellar mass and the Radial Acceleration Relation.

Conclusion: Accounting for observational uncertainties in stellar density profiles is crucial for accurate dynamical mass estimation in dwarf spheroidal galaxies, as standard methods can produce substantial systematic errors that alter fundamental scaling relations.
...
TL;DR: First statistical study of MgII-emitting halos in 47 star-forming galaxies at 0.7<z<2.0 reveals extended emission out to tens of kpc, with outflow properties correlating with stellar mass and star formation activity.
...
Method: Used deep MUSE observations of 47 star-forming galaxies at 0.7<z<2.0. Extended previous single-object outflow modeling framework to larger sample, modeling outflows as ensemble of radially accelerating shells. Analyzed extended MgII emission out to tens of kiloparsecs.

Result: Galaxies with MgII outflows have higher SFRs, sSFRs, and younger stellar populations. Winds accelerate linearly with radius from ~60 km/s launching velocities to maximum velocities correlating with stellar mass (up to ~490 km/s). Inner regions are highly opaque with tentative stellar mass-central optical depth trend. Opening angle depends on stellar mass: less massive galaxies show wide opening angles, more massive show both wide and narrow. Halo spatial extent peaks at ~5 kpc HLR with tail up to ~20 kpc. Compact halos (HLR<8 kpc) correlate with stellar mass, extended halos do not.

Conclusion: This first statistical study reveals systematic relationships between outflow properties and host galaxy characteristics, suggesting star-formation-driven winds. The difference in stellar mass correlation between compact and extended halos may indicate different powering mechanisms. Results provide population-level constraints on circumgalactic outflows traced by MgII emission.
...
TL;DR: Astrochemical models developed for interstellar medium can be adapted to simulate laboratory astrophysics experiments on CO hydrogenation to methanol, showing fair agreement despite some discrepancies between models and experiments.


<details>
  <summary>Details</summary>
Motivation: To demonstrate whether rate-equation-type astrochemical models developed for interstellar medium conditions can be directly compared with laboratory astrophysics experiments, addressing the historical gap between astrochemical modeling and experimental data.

Method: Conducted 9 low-temperature CO hydrogenation experiments varying temperature and dose parameters, then used three astrochemical codes (NAUTILUS, pyRate, and MONACO) to simulate experimental conditions, carefully converting vocabulary and scales for fluxes and time scales.

Result: Demonstrated that different astrochemical codes can be used to directly compare modeling results with experimental outputs, achieving fair agreement despite some discrepancies between models and experiments, as well as between different models themselves.

Conclusion: It is possible to adapt interstellar medium astrochemical models to simulate laboratory experiments, though differences may originate from chemical network variations or descriptions of physical processes, highlighting the need for careful vocabulary and scale conversions.
...
<details>
  <summary>Details</summary>
Motivation: The rhoOphW PDR exhibits bright excess microwave emission (EME) attributed to spinning dust grains, but detailed morphology and spectral characteristics remain unclear. Deep imaging and spectroscopy are needed to understand the EME signal's structure, search for spectral fine features, and constrain the high-frequency spectral drop-off.

Method: ALMA Band1 mosaic observations (36-44GHz) provide deep deconvolved images of the filament. Cross-correlation in the uv-plane extracts spectra using the Band1 image as template. Simulations and cross-correlations with near-infrared ancillary data (IRAC 3.6μm) estimate flux-loss and biases. Multi-frequency intensity measurements enable spectral modeling.

Result: The EME spectrum follows a power law with spectral index α=-0.78±0.05, showing no detectable fine structure. Band1 power increases relative to IR emission at higher spatial frequencies (2× more power at ~20″ vs ~100″ scales). A compact radio-only EME source without IR counterpart is discovered embedded in filamentary Band1 signal, while IRAC maps remain smooth in the same region.

Conclusion: The power-law spectrum without fine structure supports spinning dust emission interpretation. The spatial power distribution differences between radio and IR suggest distinct emission mechanisms or grain populations. The discovery of compact radio-only structures indicates localized EME sources potentially revealing different physical conditions or grain properties within the PDR.
...
TL;DR: JWST medium-band photometry reveals shallow nebular attenuation curve and patchy dust geometry in cosmic noon star-forming galaxies, with dustiness increasing with stellar mass and SFR.


<details>
  <summary>Details</summary>
Motivation: To constrain the nebular attenuation curve and investigate dust geometry in star-forming galaxies at cosmic noon (z~1.2-2.4) using JWST medium-band emission line measurements, addressing uncertainties in dust properties during peak cosmic star formation.

Method: Used JWST/MegaScience/UNCOVER medium-band photometry to measure Hα fluxes for 209 galaxies at 1.2<z<2.4 and Paβ fluxes for 66 galaxies. Analyzed Paβ/Hα and Hα/Hβ line ratios to study dust attenuation. Compared with MOSDEF spectroscopic sample and tested different attenuation curves (Reddy et al. 2025 vs. Cardelli et al. 1989).

Result: Paβ/Hα ratio increases strongly with stellar mass and SFR, indicating more massive galaxies are dustier. Shallow Reddy et al. (2025) attenuation curve fits observations better than Cardelli curve, especially for massive galaxies. No correlation between A_Hα,neb and axis ratio suggests nebular attenuation is localized to small clumps. Inferred A_Hα,neb can increase by up to 1 magnitude at high masses with shallower curve.

Conclusion: Dust geometry in cosmic noon galaxies is patchy and non-uniform, particularly in massive systems. JWST medium bands enable statistical constraints on dust properties, revealing shallow attenuation curves consistent with low dust covering fractions in star-forming regions.
...
TL;DR: Discovery of 323 superfine dusty fibrils (width ~0.01 pc) within 121 massive star-forming clumps across the Galaxy using ALMA-QUARKS survey data, revealing denser structures than previously known filaments.


<details>
  <summary>Details</summary>
Motivation: To investigate filamentary structures at smaller scales within massive star-forming regions and understand their role in star formation across different Galactic environments.

Method: Used ALMA-QUARKS survey 1.3 mm continuum emission data with ~900 AU resolution, identified fibrils using FilFinder software, and analyzed their properties with RadFil software across 121 clumps at various Galactocentric distances.

Result: Discovered 323 superfine fibrils with typical width ~0.01 pc (10× narrower than Herschel filaments), following M∝L² scaling relation but with significantly higher densities (N_H₂ = 10²³-10²⁴ cm⁻²) than previous surveys.

Conclusion: These superfine fibrils represent a new scale of filamentary structure in massive star formation, emphasizing the hierarchical nature of filaments and their crucial role across multiple physical scales in the star formation process.
...
<details>
  <summary>Details</summary>
Motivation: To investigate whether AGN feedback is responsible for quenching star formation in nearby galaxies, given the lack of strong AGN in quenching galaxies raises questions about AGN effectiveness in this process.

Method: Analyzed AGN activity in post-starburst galaxies (PSBs), star-forming galaxies (SFGs), and quiescent galaxies (QGs) at z<0.2 using multiwavelength data from eROSITA/eFEDS (X-ray), WISE (mid-infrared), and FIRST (radio). Applied stacking techniques to undetected galaxies to recover average AGN properties and compared observed luminosity to that expected from star formation.

Result: PSBs show radio and X-ray emission consistent with star formation dominance. Although PSBs have twice the MIR AGN incidence rate of SFGs, their estimated AGN luminosities are small compared to literature MIR AGN. PSBs overall do not display significantly enhanced AGN emission relative to mass- and redshift-matched SFGs and QGs.

Conclusion: AGN's role in quenching at low redshift is subtle rather than violent - feedback is likely more "preventive" than "ejective." While obscured, low-luminosity AGN may exist in PSBs fueled by residual gas from preceding starbursts, they likely don't play a dominant role in quenching.
...
TL;DR: Deep HST UV observations combined with gravitational lensing enable measurement of the UV luminosity function at z~0.55 down to extremely faint magnitudes, ruling out a turn-over brighter than M_UV = -15.5 at 3σ confidence.


<details>
  <summary>Details</summary>
Motivation: To probe the faint end of the UV luminosity function at intermediate redshifts (0.4 < z < 0.7) by leveraging deep HST UV observations and gravitational lensing magnification from the Hubble Frontier Fields cluster Abell 2744.

Method: Extended HFF observations to F225W band using HST WFC3/UVIS; combined deep Near-UV imaging with gravitational lensing magnification; identified 152 faint galaxies through hybrid photometric-spectroscopic redshift selection; used maximum likelihood estimation with Schechter function including curvature parameter δ to account for possible faint-end turn-over.

Result: Measured UV LF at z~0.55 down to M_UV < -13.5 mag with faint-end slope α = -1.324^{+0.072}_{-0.074}; ruled out a turn-over brighter than M_UV = -15.5 at 3σ confidence level; catalog of faint galaxies with -19.5 < M_UV < -12.1.

Conclusion: The study successfully probes the extremely faint galaxy population at intermediate redshifts, finding no evidence for a turn-over in the UV luminosity function at luminosities brighter than M_UV = -15.5, providing important constraints on galaxy formation models.
...
TL;DR: JWST observations of z>9 galaxies reveal highly efficient star formation with rapid gas depletion timescales, driven by dense neutral hydrogen gas that explains their UV-brightness at cosmic dawn.


<details>
  <summary>Details</summary>
Motivation: To address the conundrum of UV-bright galaxy overabundance at z≳9 by studying gas assembly and star formation efficiency in early galaxies using JWST/NIRSpec observations.

Method: Analyzed JWST/NIRSpec Prism spectra of confirmed z>9 galaxies, modeling rest-frame UV to optical continua and line emission, particularly damped Lyman-α absorption features to derive HI column densities and SFR surface densities.
...
TL;DR: The paper analyzes planetary tidal influences on solar activity, finding that a 1.723-year period in solar events matches the beat frequency between Venus, Earth, and Jupiter spring tides, suggesting tidal synchronization of solar cycles.


<details>
  <summary>Details</summary>
Motivation: To investigate the connection between planetary tidal forces and solar activity patterns, particularly the quasi-biennial oscillation (QBO) and solar flare events, building on evidence that Magneto-Rossby waves in the solar tachocline may be influenced by planetary tides.

Method: Analysis of 72 ground-level enhancement (GLE) events and 37 S-flares to determine dominant periodicities, comparison with calculated beat periods from spring tides of Venus, Earth, and Jupiter, and examination of alignment between recent solar events and tidal forcing maxima.

Result: The dominant period in solar events is approximately 1.723 years, which matches the beat frequency between planetary spring tides; recent solar storms (2024 May 10, 2026 February 1) align with tidal forcing maxima, though the Carrington event (1959 September 1) does not fit this pattern.

Conclusion: Planetary tidal forces, particularly from Venus, Earth, and Jupiter, appear to synchronize solar activity cycles including the quasi-biennial oscillation and potentially the Schwabe cycle, though not all major solar events follow this tidal pattern.
...
TL;DR: 3D magnetohydrodynamic simulations show that preexisting turbulence and magnetic fields from the smoldering phase enhance mixing between burned/unburned material, solving the white dwarf pre-expansion problem in delayed detonation models.


<details>
  <summary>Details</summary>
Motivation: 3D hydrodynamic simulations of delayed detonation models show insufficient white dwarf expansion during deflagration phase, creating inconsistency with spherical models that successfully reproduce Type Ia supernova observations.

Method: Used 3D magnetohydrodynamic simulations with FLASH code, incorporating preexisting turbulent velocity fields and strong magnetic fields expected from smoldering phase, focusing on early deflagration stage dominated by laminar burning speed.

Result: Turbulence and magnetic fields promote entrainment of burned material into unburned pockets, enabling conductive ignition of surrounding fuel and approaching spherical model burning efficiency, addressing the pre-expansion problem.

Conclusion: Enhanced mixing between burned/unburned material via turbulence and magnetic fields, not changes in small-scale flame physics, solves the fundamental inconsistency in 3D delayed detonation models by enabling proper white dwarf pre-expansion.
...
TL;DR: Simulating solar flares with inverse FIP effect coronal composition shows coronal rain formation is more difficult compared to solar-like FIP conditions.


<details>
  <summary>Details</summary>
Motivation: To understand how extreme non-solar coronal compositions (inverse FIP effect observed on M-dwarf stars) affect coronal condensation formation during solar flare simulations, since dynamic modeling of spatio-temporal abundance variations improves radiative hydrodynamic simulation accuracy.

Method: Using hydrodynamic flare models with field-aligned simulations starting with an initial corona dominated by inverse FIP effect (high FIP elements enriched, low FIP elements depleted), similar to M-dwarf star conditions, and comparing to solar FIP effect cases.

Result: Flaring events in coronae enriched with high FIP elements produce solutions similar to solar cases, but coronal rain formation is more difficult when the corona is depleted of low FIP elements, as observed on M-dwarfs.

Conclusion: Coronal composition significantly influences coronal condensation formation during flares, with inverse FIP conditions making rain formation more challenging compared to solar-like FIP conditions, highlighting the importance of dynamic abundance modeling in stellar flare simulations.
...
TL;DR: 3D reconstruction of magnetic field and plasma parameters in a solar flare using combined microwave and stereoscopic X-ray data reveals magnetically dominated environment.


<details>
  <summary>Details</summary>
Motivation: Diagnosing solar flare conditions is essential for understanding coronal energy release, requiring three-dimensional characterization of magnetic field and plasma parameters during flare events.

Method: Combined microwave imaging spectroscopy from EOVSA to derive magnetic field strength, electron densities, and power-law index through gyrosynchrotron modeling, plus stereoscopic X-ray observations from Hinode/XRT and Solar Orbiter/STIX for 3D reconstruction of flaring loop geometry.
...
Conclusion: The 3D maps provide valuable constraints for models of magnetic reconnection and flare dynamics, representing a step toward realistic three-dimensional characterization of energy release in solar eruptive events.
...
TL;DR: Six globular clusters (M13, M92, NGC 104, NGC 362, NGC 1261, NGC 1851) identified as optimal calibration fields for CSST's on-orbit calibration program based on comprehensive selection criteria.


<details>
  <summary>Details</summary>
Motivation: The Chinese Space Station Survey Telescope (CSST) requires stable celestial benchmark fields for rigorous on-orbit calibration to maintain photometric and astrometric consistency throughout its decade-long high-precision wide-field imaging survey.
...
Conclusion: The selected six globular clusters are fundamental to achieving unprecedented photometric precision in CSST's space-based survey and will serve as stable celestial benchmark fields for maintaining calibration consistency throughout the mission lifetime.
...
TL;DR: Nonlinear damping of coronal loop oscillations via Kelvin-Helmholtz instability-induced turbulence is studied through 3D MHD simulations and forward modeling, revealing observational signatures and limitations for seismological inference.


<details>
  <summary>Details</summary>
Motivation: Large-amplitude decaying kink oscillations of coronal loops are strongly influenced by nonlinear processes like Kelvin-Helmholtz instability and turbulence, but comprehensive theory and observational confirmation remain limited. The study aims to investigate observational signatures of nonlinear turbulence damping in transverse loop oscillations.

Method: The research uses 3D magnetohydrodynamic simulations and forward-modelled EUV images to investigate observational signatures of nonlinear damping by KHI-induced turbulence. Bayesian fitting is applied to analyze oscillation parameters and their constraints.

Result: Simulated oscillations show time-varying frequency shifts and damping rates consistent with nonlinear turbulence-damping theory, plus excitation of higher-order modes, slightly increased periods, and reduced displacement amplitudes. Synthetic observations preserve these features but require higher spatial resolution for higher-order modes. Hotter channels show faster decay with smaller displacements and larger phase shifts. Bayesian fitting reveals robust constraints on initial amplitude and kink period, but damping parameters are degenerate.

Conclusion: The results provide a quantitative basis for identifying nonlinear damping and detecting KHI-driven turbulence in transverse loop oscillations, though additional observables are needed for reliable seismological inference due to parameter degeneracy in damping profiles.
...
TL;DR: This paper derives surface brightness-color relations (SBCRs) for classical Cepheids in the Milky Way and Magellanic Clouds using Gaia data, quantifying metallicity effects on these relations.


<details>
  <summary>Details</summary>
Motivation: To establish accurate SBCRs for classical Cepheids that account for metallicity effects, enabling precise distance measurements via the inverse Baade-Wesselink method for Gaia-observed Cepheids.

Method: 1) Quality-filtered Gaia photometric data and parallaxes for Milky Way Cepheids; 2) Compiled literature period-radius relations and derived new PR relation from interferometric data; 3) Combined radii with distance estimates (Gaia parallaxes for MW, eclipsing binaries for Magellanic Clouds) to derive surface brightness and color for ~1700 Cepheids.

Result: 1) New PR relation: log(R/R⊙) = 1.133±0.019 + 0.688±0.016 log(P); metallicity doesn't affect PR relations. 2) Three SBCRs showing metallicity dependence in Gaia magnitudes. 3) Metallicity-dependent slope and zero point relations: Slope = -0.0663±0.0121[Fe/H] - 0.3010±0.0030; ZP = -0.1016±0.0091[Fe/H] + 3.9988±0.0029.

Conclusion: The new metallicity-dependent SBCRs are crucial for applying the inverse Baade-Wesselink method to classical Cepheids observed by Gaia in future studies.
...
TL;DR: B335 protostar's ongoing outburst affects its jet; proper motions of shock fronts show kinematic age matching outburst onset; ice absorption and extinction mapping reveal outflow cavity structure.


<details>
  <summary>Details</summary>
Motivation: To study the effects of a major ongoing outburst on the jet of a protostellar object, using B335 as a rare opportunity to observe such phenomena in real-time.

Method: Used photometry of background stars to map visual continuum extinction and H2O ice absorption; obtained precise proper motions of shock fronts; analyzed spectral features including CO, H2, and [Fe II] emission lines; measured ice absorption features near protostar.

Result: Outflow has carved a cavity; shock front 3E's kinematic age corresponds to outburst onset; emission features show chemical evolution with age; extreme extinction gradient near protostar (ΔAV ≈ 200 mag); increasing column densities of ice species toward protostar; CO shows both emission and absorption features.

Conclusion: The ongoing outburst in B335 has directly impacted its jet structure and chemistry, with shock fronts showing age-dependent chemical evolution and extreme extinction gradients near the protostar revealing complex outflow cavity geometry.
