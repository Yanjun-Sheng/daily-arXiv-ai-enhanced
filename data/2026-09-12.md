...
### [1] [The Dyn-Atmo Survey: High-contrast Imaging Spectroscopy of the Substellar Companion HD 13724 B with the JWST NIRSpec IFU](https://arxiv.org/abs/2609.11827)
...
TL;DR: JWST NIRSpec/G395H IFU spectra of the T4-dwarf companion HD 13724 B are analyzed using self-consistent model grids and atmospheric retrievals; dynamical mass priors improve constraints, but model parameter degeneracies limit precise atmospheric inference.


<details>
  <summary>Details</summary>
Motivation: Directly-imaged companions with dynamical masses and measured orbits are benchmark objects for atmospheric characterization, but their low signal-to-noise spectra and model degeneracies pose major challenges. The Dyn-Atmo Survey aims to establish robust atmospheric constraints for such benchmarks, and HD 13724 B serves as an initial test case.

Method: The JWST Cycle 3 GO Program #6362 obtained moderate-resolution spectra (R~2700, 3-5 micron) of the T4-dwarf companion HD 13724 B using NIRSpec/G395H IFU. Updated orbital monitoring constrains the dynamical mass to 38.3+/-0.6 M_Jup, applied as a Gaussian prior. The continuum-subtracted spectrum is fit with BT-SETTL, Sonora Diamondback, Sonora Flame Skimmer, and NEWERA-PHOENIX self-consistent model grids, plus petitRADTRANS atmospheric retrievals.

Result: Bulk parameters from a Bayesian average across model grids: T_eff = 1150+/-195 K, log g = 5.1+/-0.3 dex, [M/H] = 0.4+/-0.4, log10(K_zz) = 6.33 (-2.22,+2.59), and C/O = 0.50+/-0.13. Degeneracies between surface gravity, metallicity, and K_zz are found for Sonora Diamondback and Flame Skimmer. Flame Skimmer and NEWERA-PHOENIX yield incompatible vertical mixing strengths, with Flame Skimmer systematically lower. Retrievals favor chemical equilibrium, enhanced metallicity, and solar C/O, with no detection of disequilibrium chemistry or trace gases beyond CH4, CO2, 12CO, and H2O.

Conclusion: Forward modeling of continuum-subtracted G395H spectra in the low signal-to-noise regime presents critical challenges. Independent dynamical mass measurements better constrain atmospheric parameters, but degeneracies among self-consistent model parameters prevent accurate atmospheric inferences.
