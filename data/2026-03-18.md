...
TL;DR: Multi-phase outflow study in NLSy1 galaxy IRAS 17020+4544 reveals fast ionized outflow in energy-conserving regime and slower momentum-driven component, with molecular outflow dominating mass and feedback efficiency.


<details>
  <summary>Details</summary>
Motivation: To investigate properties and kinematics of warm ionized gas in IRAS 17020+4544, a rare NLSy1 galaxy with multi-phase outflow, and characterize outflow energetics and feedback mechanisms.

Method: Used MEGARA integral-field spectroscopy at GTC in low- (R~6000) and medium-resolution (R~12000) modes, performed multi-Gaussian fitting of Hα and [OIII]λ5007 lines, applied ionization diagnostic diagrams (WHAN, WHaD, BPT), and compared with X-ray and molecular outflow data.

Result: Detected fast ionized outflow (v~1460 km/s in Hα, 1240 km/s in [OIII], R~1 kpc) in energy-conserving regime, slower outflow (v~450 km/s) in momentum-driven regime, both enclosed within larger molecular outflow (R=2.8±0.3 kpc). Molecular outflow dominates mass and feedback efficiency.

Conclusion: IRAS 17020+4544 exhibits efficient AGN feedback dominated by radiatively driven winds (quasar-mode) rather than jet-driven processes, with multi-phase outflow structure where molecular phase carries most mass and feedback impact.
...
TL;DR: HI imaging of 22 HI-rich Seyferts reveals most have HI-detected neighbors with gas exchange signatures, extended HI disks correlate with stronger AGN activity, suggesting external gas accretion fuels AGNs.


<details>
  <summary>Details</summary>
Motivation: To understand how cool gas is supplied to AGN hosts, particularly examining the role of environmental gas accretion through galaxy interactions in fueling active galactic nuclei.

Method: Neutral atomic hydrogen (HI) imaging observations of 22 HI-rich, hard X-ray-selected local Seyfert galaxies, analyzing HI morphology, neighbor detection, gas exchange signatures, HI size-mass relations, and star formation properties.

Result: 80% of galaxies have HI-detected neighbors, 61% show clear gas exchange signatures; HI-rich AGN hosts follow known scaling relations; extended HI disks correlate with stronger AGN activity, especially when neighbors are gas poor; sample galaxies are typically the most massive in their groups.

Conclusion: Environmentally accreted gas through galaxy interactions and gas exchange with neighboring systems likely supplies additional fuel to AGNs, with extended HI disks serving as indicators of external gas accretion processes.
...
TL;DR: JWST identifies extremely metal-poor galaxies (EMPGs) at z>3 using photometric selection from JADES medium-band imaging, revealing low-mass, faint dwarf galaxies with high ionizing photon production efficiencies.


<details>
  <summary>Details</summary>
Motivation: To accelerate understanding of pristine star formation by developing a methodology to identify extremely metal-poor galaxy candidates from photometry, leveraging JWST's capabilities to study early galaxy formation.

Method: Developed photometric selection method using JADES deep medium-band imaging to identify EMPG candidates at 2.5<z<6.5 based on strong Hα emission but weak [O III]+Hβ emission, indicating low metallicity. Used SED-fitting with near-pristine models (0.1-1% solar metallicity) to characterize properties.

Result: Identified 22 EMPG candidates with low mass (median M*≈10^6.7 M⊙), faint (MUV≈-16.6), high ionizing photon production efficiencies (log(ξ_ion,obs/(Hz erg^-1))≈26.0), comprising 0.04-0.6% of galaxies at 2.5<z<6.5 with -19<MUV<-16.

Conclusion: JWST enables identification of extremely metal-poor galaxies through photometric selection, revealing plausible sites of near-pristine star formation. Future NIRCam slitless spectroscopy and NIRSpec observations will further characterize these systems and discover fainter pristine galaxies out to z=10.
...
<details>
  <summary>Details</summary>
Motivation: To resolve the contradiction between the observed linear Gao-Solomon relationship (HCN luminosity ∝ SFR) and resolved observations showing HCN traces gas below the star formation threshold density.
...
Result: No correlation between HCN emission and SFR; HCN brightness remains constant over orders of magnitude in SFR. N₂H⁺ shows weak positive correlation with SFR. N₂H⁺/HCN ratio correlates linearly with dense gas fraction.

Conclusion: The extragalactic HCN-SFR correlation results from averaging over many clouds with similar dense gas fractions, not from HCN directly tracing star-forming gas.
...
<details>
  <summary>Details</summary>
Motivation: To test whether other galaxies in the linear trail of low-luminosity galaxies in the NGC 1052 field, which includes the dark-matter-deficient DF2 and DF4, also lack dark matter, particularly focusing on DF9 which closely resembles DF2 and DF4.

Method: Used Keck/KCWI absorption line spectroscopy to measure DF9's stellar velocity dispersion, comparing the observed value with expectations from stellar mass alone versus predictions from the stellar mass-halo mass relation.
...
Conclusion: DF9 lacks dark matter like DF2 and DF4, supporting the hypothesis that the trail galaxies formed together through a unique formation channel (e.g., bullet dwarf collision) and that other trail galaxies should similarly show dark matter deficiency.
...
TL;DR: Analysis of M51 group galaxies using J-PLUS data reveals distinct properties shaped by environmental processes, with flatter age/metallicity gradients than M101 group, indicating more advanced dynamical evolution.


<details>
  <summary>Details</summary>
Motivation: To understand how environmental processes shape galaxy properties across different groups by characterizing the spatially resolved stellar population and emission-line properties of galaxies in the M51 group, comparing with previous M101 group analysis.

Method: Applied the AlStar spectral fitting code to multi-band datacubes from the Javalambre Photometric Local Universe Survey (J-PLUS) to derive spatially resolved maps of stellar population and emission-line properties for M51 group galaxies.

Result: M51a/b pair shows distinct properties: M51a has star-forming spiral arms, M51b is an early-type retired galaxy. M63 exhibits asymmetries consistent with outside-in quenching. Age-Σ⋆ and nebular metallicity-Σ⋆ relations are flatter than in M101 group. All galaxies align with resolved star-forming main sequence except M51b. M51 group shows flattened age/metallicity gradients, enhanced dust, and environmental quenching signatures.

Conclusion: M51 group displays more advanced dynamical evolution than M101 group, evidenced by flattened gradients and environmental quenching. Group mass and interactions influence galaxy evolution even in low-mass environments, though limited by small-number statistics. J-PLUS data shows potential for IFS-like analyses of nearby galaxies.
...
TL;DR: Discovery of Type Ia supernova SN 2025adpq located within a massive collisional ring (Pika's Halo) formed by a major galaxy merger, demonstrating that old stellar populations can be displaced to large distances from their host galaxies via merger-induced pressure waves.


<details>
  <summary>Details</summary>
Motivation: To understand the origin of large-offset Type Ia supernovae and investigate how galaxy mergers can displace old stellar populations far from their birthplaces, potentially explaining seemingly hostless SNe Ia.

Method: Used optical spectroscopy from Southern African Large Telescope (SALT) and Gemini South to analyze SN 2025adpq at z=0.1540 within a collisional ring system. Studied stellar populations in the ring through spectral features including Calcium H and K absorption. Identified other supernovae in low-redshift collisional ring galaxy samples for comparison.

Result: SN 2025adpq is located at ~11.4 kpc projected offset from the primary galaxy within a ~70 kpc circumference collisional ring formed by a major merger of two ~log(M*/M⊙)≈10.5 galaxies. Spectroscopy shows both merger-induced ongoing star formation and substantial old stellar population in the ring. The supernova likely originated from an old progenitor system displaced during the head-on galaxy collision.

Conclusion: Collisional rings provide a pathway for producing large-offset Type Ia supernovae by displacing old stellar populations via collisionally induced pressure waves. This motivates targeted searches for faint, dynamically displaced old populations in seemingly hostless SN Ia environments.
...
TL;DR: Young star clusters inherit fractal structure from molecular clouds, lose it within ~2.5 free-fall times via dynamical relaxation, but massive stars can create secondary subclusters through feedback, extending fractal structure beyond 4 free-fall times.
...
Result: Clusters inherit fractal substructure from parental clouds, typically erased within ~2.5 free-fall times through dynamical relaxation. Massive stars can induce secondary subcluster formation via feedback, with outcomes dependent on stellar mass and formation timing. Subcluster interactions (mergers, dispersal) can extend fractal structure beyond 4 free-fall times. Positive correlation found between fractality parameter Q and both correlation and box-counting dimensions, with stronger correlation for correlation dimension.

Conclusion: Stellar feedback and internal dynamics jointly shape the measurable fractal properties of embedded star clusters, demonstrating how cluster structure evolves from inherited cloud substructure through complex interplay of dynamical relaxation and feedback-driven processes.
...
TL;DR: SOFIA/HAWC+ 214 μm polarimetry reveals magnetic field structure in infrared dark cloud G351.77-0.53, showing hourglass-shaped field toward star-forming clump c1 and perpendicular orientation elsewhere, with magnetic fields playing dominant role in cloud dynamics.


<details>
  <summary>Details</summary>
Motivation: To investigate the role of magnetic fields in star formation within infrared dark clouds, specifically examining magnetic field configurations and their influence on gas dynamics in the G351.77-0.53 filament.

Method: Combined SOFIA/HAWC+ 214 μm polarimetric observations with existing multi-wavelength datasets, used Davis-Chandrasekhar-Fermi method to estimate magnetic field strength, analyzed mass-to-flux ratios, and conducted energy budget analysis.

Result: Distinct hourglass-shaped magnetic field configuration toward star-forming clump c1, perpendicular field orientation elsewhere in filament. Mean plane-of-sky magnetic field strength ~147 ± 60 μG, reaching ~0.8 mG toward c1. Filament is magnetically transcritical with comparable gravitational and magnetic energies.

Conclusion: Magnetic fields play the most important role in governing cloud gas dynamics, followed by turbulence and gravity. The hourglass-shaped field toward c1 likely results from magnetically regulated gravitational collapse, alignment of converging sub-filaments with magnetic field, or combination of both processes.
...
TL;DR: DESI spectroscopic data used with MG-MAMPOSSt to constrain Coma cluster mass profile and velocity anisotropy, finding virial mass ~1.08×10¹⁵ M⊙ and analyzing galaxy population kinematics.


<details>
  <summary>Details</summary>
Motivation: To provide the tightest robust kinematic mass profile constraint for the Coma cluster using new DESI spectroscopic data, and to investigate the interplay between galaxy dynamical properties and intrinsic characteristics in massive structures.

Method: Used MG-MAMPOSSt code based on Jeans equation to jointly reconstruct total cluster mass profile and velocity anisotropy profile from DESI spectroscopic data. Applied Navarro-Frenk-White model, considered hot gas and stellar mass contributions, assessed dynamical state, and performed kinematic analysis of galaxy populations by color (red sequence, green valley, blue cloud).

Result: Virial mass M₂₀₀ = 1.08⁺⁰·⁰⁸₋₀·₀₉ (stat) ± 0.09 (syst) × 10¹⁵ M⊙, r₂₀₀ = 2.12 ± 0.06 Mpc, scale radius rₛ = 0.48⁺⁰·²⁷₋₀·₁₃ Mpc. Dark matter mass M₂₀₀ᴰᴹ = 8.6⁺¹·²₋₀·₈ × 10¹⁴ M⊙. Green valley and blue cloud galaxies show more radial orbits in center and outskirts respectively, with blue cloud predicting higher cluster virial mass.

Conclusion: This study provides new insights into galaxy dynamics in massive clusters, revealing population-dependent orbital anisotropies and demonstrating the tight connection between galaxy evolution and environment through kinematic analysis.
...
### [11] [A Unified Origin of Faraday Rotation toward 3C 84: The Circumnuclear Ambient Medium within the Parsec-Scale Bondi Radius of the Host Galaxy NGC 1275](https://arxiv.org/abs/2603.16796)
...
TL;DR: Multi-frequency polarimetric observations of 3C 84 reveal a systematic decrease in Faraday rotation measure with distance from the black hole, following RM ∝ r^{-2.7}, indicating a stable external Faraday screen from the circumnuclear ambient medium within NGC 1275's Bondi radius.


<details>
  <summary>Details</summary>
Motivation: To resolve the long-standing question about the physical origin of Faraday rotation in 3C 84/NGC 1275 by characterizing the circumnuclear environment through multi-frequency polarimetric observations.
...
Result: RM decreases systematically with distance from the black hole (1-8 pc) following RM ∝ r^{-2.7±0.2}, consistent across epochs, frequencies, and independent datasets. This identifies the circumnuclear ambient medium within the Bondi radius as the Faraday screen. Derived electron density and magnetic-field strength distributions are consistent with independent constraints, with magnetic field increasing from 0.1-1.5 μG at Bondi radius to mG-G levels toward the black hole.

Conclusion: The study presents the first spatially resolved constraint on magnetic-field strength at parsec-scale distances in an elliptical galaxy, providing a physically consistent picture of the circumnuclear environment in NGC 1275 and resolving the origin of Faraday rotation as the circumnuclear ambient medium within the Bondi radius.
...
### [12] [Magnetar counterparts, kinematics and birth sites with HST and JWST](https://arxiv.org/abs/2603.15750)
...
TL;DR: Magnetar kinematics study using HST/JWST reveals proper motions, birth sites, and velocity distribution differences from young pulsars.


<details>
  <summary>Details</summary>
Motivation: Magnetars have uncertain formation channels and represent a significant fraction of young neutron stars. Understanding their kinematics and birth sites can constrain formation mechanisms and their role in powerful astrophysical explosions.

Method: Used Hubble Space Telescope (HST/WFC3) and James Webb Space Telescope (JWST/NIRcam) imaging to identify magnetar counterparts in near-infrared based on variability, colors, and proper motion outliers. Precise proper motions obtained by tying observations to Gaia reference frame.

Result: Identified new counterpart candidates for three magnetars (PSRJ1622-4950, 1RXSJ170849.0-400910, CXOUJ164710.2-455216). Found 1RXSJ170849.0-400910 trajectory coincides with supernova remnant G346.6-0.2. Magnetar transverse velocity distribution marginally inconsistent with young pulsars due to dearth of high-velocity magnetars. Candidate birth sites identified in most cases, suggesting characteristic ages often underestimate true ages.

Conclusion: Magnetars are kinematically similar to wider Galactic neutron star population, supporting magnetar formation as common outcome of massive star core-collapse. Tentative evidence for fewer high-velocity magnetars suggests possible progenitor population differences or post-formation velocity evolution variations.
...
### [13] [Self-Consistent Nonlinear Classical Cepheid Pulsations During Stellar Evolution with MESA](https://arxiv.org/abs/2603.15766)
*Ebraheem Farag,Earl P. Bellinger,Philip Mocz,Selim Kalici,R. Smolec,Shashi Kanbur,Kyra Bettwy,Christopher Lindsay*

Main category: astro-ph.SR

TL;DR: MESA extended with eddy-viscous damping in time-dependent convection, enabling first self-consistent integration of large-amplitude Classical Cepheid pulsations within evolutionary runs, unifying MESA-star and MESA-RSP modules.


<details>
  <summary>Details</summary>
Motivation: To align MESA-TDC with MESA-RSP's radial pulsation framework, enable self-consistent evolution-pulsation coupling, and eliminate reliance on separate post-processing workflows for stellar pulsation studies.

Method: Introduced eddy-viscous damping in time-dependent convection treatment in MESA, integrated modifications into MESA-star module, demonstrated evolution of 6 M☉ blue-loop model through pulsations with core excision and envelope remeshing to match MESA-RSP grid.

Result: Eddy viscosity inclusion remains stable on evolutionary timescales; first self-consistent integration of nonlinear Classical Cepheid pulsations achieved; reasonable agreement found between MESA-star and MESA-RSP pulsation properties (period, light/radius curves, growth rates).

Conclusion: Unified approach enables fully coupled evolution-pulsation simulations, opens possibilities for studying pulsations with composition gradients, mass loss, rotation, ε mechanism, and provides physical viscosity source for MESA's hydrodynamics solver.
...
### [14] [Confidently Wrong: Why Ignoring Binaries Biases IMF Inference at Large Sample Sizes](https://arxiv.org/abs/2603.15779)
*Anna L. Rosen*

Main category: astro-ph.SR

TL;DR: Unresolved binaries in photometric samples systematically bias IMF high-mass slope measurements, with biases (0.01-0.09) potentially exceeding reported uncertainties at large sample sizes, requiring binary-aware inference for accurate results.


<details>
  <summary>Details</summary>
Motivation: To quantify the systematic bias introduced by fitting single-star models to photometric samples containing unresolved binaries when measuring the stellar initial mass function (IMF) high-mass slope, and to determine when this bias becomes significant relative to statistical uncertainties.

Method: The study brackets the bias between two limiting observation operators: mass-addition (upper bound on mass overestimation) and luminosity-addition (lower-bias photometric case based on ZAMS mass-luminosity relation). It analyzes four astrophysical environments spanning α=1.60-2.30 and compares results to a binary-aware mixture likelihood that marginalizes over the Moe & Di Stefano (2017) binary population model.

Result: Mass-addition bias ranges from 0.054-0.086 with crossover to "confidently wrong" at N_cross ∼ 5,000-10,000; luminosity-addition bias ranges from 0.011-0.021 with N_cross ∼ 75,000-150,000. The binary-aware mixture likelihood successfully recovers the true slope in synthetic tests.

Conclusion: Published single-star IMF slopes can carry systematic errors of order 0.01-0.09 if unresolved binaries are not modeled, comparable to or exceeding reported uncertainties. With current and upcoming surveys delivering N = 10^4-10^6 resolved stars per rich cluster, binary-aware inference is necessary to avoid systematic bias in the large-N single-star-fitting regime.
...
### [15] [Measurements on the kinetic origin of streamer dynamics](https://arxiv.org/abs/2603.15930)
...
<details>
  <summary>Details</summary>
Motivation: To understand the transition from closed coronal magnetic structures to open heliospheric current sheets, which involves non-MHD processes not previously resolved in-situ.

Method: Analysis of 15 streamer structures observed by Parker Solar Probe during Orbits 16-23 at 11.7-17 solar radii, measuring DC electric fields in plasma rest frame and interpreting via Generalized Ohm's Law.

Result: Observed DC electric fields up to 400 mV/m (largest in PSP mission), meridional currents of several mA/m² supporting HCS formation, and faster plasma flow speeds inside current sheets (326 km/s average) than outside (266 km/s).

Conclusion: Streamer structures exhibit significant non-MHD processes with strong electric fields and currents, challenging the traditional consensus that streamers are the source of slow solar wind.
...
### [16] [The role of ambipolar heating in the energy balance of solar prominences](https://arxiv.org/abs/2603.16391)
*Llorenç Melis,Roberto Soler*

Main category: astro-ph.SR

TL;DR: Ambipolar diffusion in partially ionized solar prominence threads provides heating that compensates radiative losses and creates stationary flows, producing thread lengths consistent with observations in 1D Kippenhahn-Schlüter models.


<details>
  <summary>Details</summary>
Motivation: To explore the role of ambipolar diffusion in solar prominence energy balance, as this effect can deposit energy from non-force-free magnetic fields into partially ionized prominence plasma.

Method: 1D models based on Kippenhahn-Schlüter configuration with sheared magnetic field, numerically computing temperature profiles by balancing radiative losses, thermal conduction, and ambipolar heating.

Result: Models produce cold, dense, partially ionized threads with prominence core conditions, thin transition regions, and extended hot coronal regions. Ambipolar heating compensates radiative losses and generates stationary flows from gravitational drainage of neutrals.
...
### [17] [Stellar Wind of Components of Detached Binary Systems](https://arxiv.org/abs/2603.16511)
*A. V. Tutukov,A. V. Sobolev*

Main category: astro-ph.SR

TL;DR: Analysis of stellar wind's role in matter exchange between components of detached binary systems, including classification, analytical criteria, and 3D gas dynamic modeling applied to systems like Sco X-1 and Vela X-1.


<details>
  <summary>Details</summary>
Motivation: To understand the role of donor stellar wind in matter exchange between components of detached binary systems, particularly in systems where direct Roche lobe overflow doesn't occur but wind-driven accretion plays a crucial role.

Method: 1. Proposed classification of close binary systems with interacting components; 2. Completed analytical tasks to evaluate conditions and efficiency of wind interaction; 3. Derived criteria for maintaining self-induced stellar wind in X-ray binaries and conditions for accretion disk formation; 4. Constructed 3D gas dynamic models for five initial stellar wind velocities using Sco X-1 type systems; 5. Analyzed simulation results through streamlines, temperature distribution, and wind gas density visualizations.

Result: 1. Developed classification system for interacting binary systems; 2. Found analytical criterion for maintaining self-induced stellar wind in X-ray binaries; 3. Established condition for accretion disk formation during wind accretion; 4. 3D models confirmed wind flow focusing by accretor; 5. Model predictions validated by observed phase X-ray light curve of Vela X-1.

Conclusion: Stellar wind plays a significant role in matter exchange in detached binary systems, with analytical criteria and 3D modeling providing insights into wind-driven accretion processes. The confirmed wind focusing effect explains observed X-ray variability in systems like Vela X-1, demonstrating the importance of wind interaction even in systems without direct Roche lobe overflow.
...
### [18] [The sensitivity and behaviour of the curvature in the échelle diagram of red-giant stars](https://arxiv.org/abs/2603.16597)
*S. Hekker,Y. Elsworth,S. Basu,F. Ahlborn,W. H. Ball,E. P. Bellinger,L. Buchele,F. Espinoza-Rojas*

Main category: astro-ph.SR

TL;DR: Analysis of curvature (second-order frequency spacing deviations) in red-giant oscillations reveals sensitivity to evolutionary phase and mass, with discrepancies between observations and models pointing to needed improvements in near-surface stellar structure modeling.


<details>
  <summary>Details</summary>
Motivation: To provide homogeneous curvature measurements for observed red-giant stars, understand differences between observational results and stellar model predictions, and reveal the connection between curvature and stellar internal structure.

Method: Used Kepler data of red-giant stars to compute curvature for several thousand stars, compared to curvature derived from MESA models, investigated trends and differences, computed sensitivity kernels to identify most sensitive stellar regions, and performed glitch analysis.

Result: Curvature is sensitive to evolutionary phase and mass; observed values and model values show discrepancies; glitch analysis theoretically provides information on location and strength of HeI and HI ionization layers.

Conclusion: Curvature provides a probe into near-surface stellar structure; deviations between observed and modeled curvature call for improvements in near-surface layers of stellar models.
...
### [19] [Stars with Plumbing Issues: The Formation of Collimated Outflows on Common-Envelope Simulations and Comparison to Water Fountains Observations](https://arxiv.org/abs/2603.16667)
*Sarah V. Borges,Philip Chang*

Main category: astro-ph.SR

TL;DR: Hydrodynamical simulations show that common-envelope evolution naturally produces circumbinary disks with collimated outflows, matching observed Water Fountain properties and providing constraints for future simulations.


<details>
  <summary>Details</summary>
Motivation: Common-envelope evolution (CEE) lacks direct observational constraints for simulations. While luminous red novae represent merger outcomes, there are no confirmed detections of ongoing events resulting in surviving close binaries. Post-CEE planetary nebulae are affected by central star winds, making Water Fountains ideal for study as they likely capture envelope ejection in progress.

Method: Hydrodynamical simulations of common-envelope evolution to investigate the formation of circumbinary disks and collimated outflows, comparing morphology and kinematics with observational data from Water Fountains.

Result: Simulations show that circumbinary disks with collimated outflows form naturally during CEE, with morphology and kinematics consistent with Water Fountain observations. These objects provide valuable constraints for understanding how CEE proceeds.

Conclusion: Water Fountains serve as crucial observational constraints for CEE simulations, capturing envelope ejection in progress. Their properties offer insights into CEE mechanisms and can guide future numerical modeling of this fundamental binary evolution process.
