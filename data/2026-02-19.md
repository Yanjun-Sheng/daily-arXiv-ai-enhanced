...
TL;DR: Study of globular cluster populations in Hydra I cluster reveals spatial dichotomy: red GCs trace central galaxies while blue GCs trace cluster potential and ICL, providing constraints on cluster assembly history.


<details>
  <summary>Details</summary>
Motivation: To understand galaxy cluster assembly through faint stellar features like intracluster light (ICL) using globular clusters as alternative tracers, particularly in the nearby Hydra I cluster.

Method: Deep VLT/FORS V- and I-band imaging to select GC candidates via VI color-magnitude diagram, divided into blue/red subpopulations; spatial distribution analysis; comparison with galaxy light and X-ray gas; novel method using GC specific frequencies and colors to constrain galaxy luminosity function evolution.

Result: Clear spatial dichotomy: red GCs concentrated around central galaxies NGC 3311/3309; blue GCs extended and offset, coinciding with X-ray gas peak. Red GCs follow galaxy light; blue GCs trace cluster potential. Blue GC specific frequency ~5× higher in ICL-dominated outskirts. Constrained past faint-end slope of galaxy luminosity function: α=-1.81 vs. α=-1.41 today.

Conclusion: GC populations provide powerful tracers of cluster assembly: red GCs trace central galaxy formation, blue GCs trace hierarchical assembly and ICL formation. Spatial and population differences reveal different formation mechanisms, with novel method successfully recovering cluster assembly history consistent with cosmological simulations.
...
TL;DR: Study identifies ~3000 new barium-rich stars from GALAH survey, finding evidence for both binary mass transfer and radiative levitation formation mechanisms across the Galaxy.


<details>
  <summary>Details</summary>
Motivation: Barium stars are chemically peculiar (Ba-enriched) and not predicted by standard Galactic chemical evolution models. Their formation mechanisms (binary mass transfer vs. radiative levitation) and Galactic distribution need clarification to constrain AGB nucleosynthesis, binary evolution, and internal stellar processes.

Method: Used ~450,000 stars from GALAH survey to identify barium-rich stars ([Ba/Fe] ≥ 1.0 dex). Separated into hot (Teff > 6000 K) and cool (Teff < 6000 K) populations. Cross-matched with Gaia DR3 to analyze multiplicity via RUWE (re-normalized unit weight error). Determined Galactic memberships using kinematics and chemistry.

Result: Identified ~3000 new barium-rich stars. Found 47.7% of barium stars within 1 kpc have elevated RUWE (≥1.4) vs. 16.3% in field stars, indicating high binary fraction. Hot barium stars with low RUWE (<1.2) and low [α/Fe] (<-0.2) support radiative levitation origin. Barium stars exist in thin disk, thick disk, and halo, slightly more prevalent at lower metallicities.

Conclusion: Both mass transfer from AGB companions and radiative levitation contribute to barium star formation, with both mechanisms occurring ubiquitously across the Galaxy. Multiplicity plays important role in formation of both hot and cool barium star populations.
...
TL;DR: Cosmological simulations reveal multiple spiral arm formation mechanisms coexist in Milky Way-mass galaxies, with pattern speeds evolving on sub-Gyr timescales, showing spiral structure is transitional without strong external perturbations.


<details>
  <summary>Details</summary>
Motivation: The dynamical nature and formation mechanisms of galactic spiral arms remain unresolved problems in astrophysics, with conflicting observational evidence about spiral pattern speeds and no clear consensus from existing theoretical work.

Method: Analysis of pattern speed profiles in the Auriga Superstars set of high-resolution cosmological magnetohydrodynamic simulations of Milky Way-mass spiral disc galaxies, featuring ~800 M⊙ star particle resolution and ~100 million star particles in discs.

Result: Multiple spiral arm theories are realized in simulations: large-scale kinematic density waves, manifold spirals, dynamic (co-rotating) spirals, and overlapping modes. Strong tidal interactions produce clear kinematic density waves, while manifold spirals appear in strongly-barred galaxies. Spiral pattern speed profiles can evolve qualitatively on sub-Gyr timescales.

Conclusion: Spiral structure in galaxies without strong external encounters or bars is highly transitional and complex, lacking clear long-lived underlying waves, explaining the mixed observational picture of spiral pattern speeds.
...
TL;DR: Radio galaxy triggering mechanisms differ between high-excitation (HERG) and low-excitation (LERGs) types, with HERGs predominantly triggered by galaxy mergers/interactions while LERGs likely accrete from hot gas halos.


<details>
  <summary>Details</summary>
Motivation: Understanding the triggering mechanisms of powerful radio-loud AGN is crucial for properly incorporating AGN feedback into galaxy evolution models.

Method: Deep imaging survey using Isaac Newton Telescope/Wide Field Camera combined with Gemini/Gemini Multi-Object Spectrograph South images, providing a 98% complete sample of 112 3CR radio galaxies with z < 0.3 alongside a stellar mass matched control sample.

Result: HERGs show high morphological disturbance rate (62%) - 4σ excess compared to control - indicating merger/interaction triggering. LERGs show lower disturbance rate (36%), consistent with control, suggesting different triggering via hot gas halo accretion. FRII HERGs preferentially reside in disturbed morphologies compared to FRII LERGs (3σ difference).

Conclusion: Different sub-types of powerful radio AGN have distinct triggering mechanisms: HERGs primarily triggered by galaxy mergers/interactions, while LERGs likely triggered by accretion from hot X-ray haloes. FRII LERGs do not simply represent a 'switched-off' phase of FRII HERGs.
...
TL;DR: Magnetic fields enhance cold cloud formation in hot galactic atmospheres, organizing cold gas into magnetized filaments that descend sub-Keplerianly toward galactic centers.


<details>
  <summary>Details</summary>
Motivation: To explain how weak magnetic fields enhance the tendency of hot galactic atmospheres to produce cold clouds and organize them into magnetized filaments, complementing recent simulations and guiding interpretation of observations.

Method: Theoretical explanation of how magnetic fields affect galactic atmosphere stability and cloud formation, focusing on hydrostatic equilibrium, convective stability, and magnetic field effects on cold gas organization.

Result: Magnetic fields promote cold cloud formation in dense galactic atmospheres, organizing the cold gas into vertically elongated, highly magnetized filaments that descend at sub-Keplerian speeds toward galactic centers.

Conclusion: Weak magnetic fields significantly enhance cold cloud production in galactic atmospheres and organize the resulting cold gas into magnetized filaments, providing theoretical framework for interpreting simulations and observations of filamentary gas in hot galactic atmospheres.
...
TL;DR: Theoretical study using GAEA semi-analytic model to quantify environmental effects (mergers, tidal interactions, ram pressure stripping, starvation) on galaxy evolution across different environments, providing context for the MAGNET observational program.


<details>
  <summary>Details</summary>
Motivation: To understand how internal and external mechanisms shape galaxy evolution by quantifying the relative importance of different environmental processes (mergers, tidal interactions, ram pressure stripping, starvation) across various environments and mass ranges.

Method: Used GAEA semi-analytic model to extract simulated volumes containing isolated galaxies, pairs, group, and filament members at z~0, avoiding massive clusters. Classified galaxies using both intrinsic (halo-based) and observational (2D projected) parameterizations, reconstructing environmental histories from z=2 to identify specific mechanisms.

Result: More than half of galaxies remain unaffected since z=2. Among affected galaxies: mergers dominate at high stellar masses (40-60% at log(M*/Msun)>10.5); tidal interactions increase with stellar mass; RPS dominates in groups/filaments at intermediate masses (~50%); starvation ranges 20-30%. Environmental imprints on global properties are often subtle but distinct evolutionary pathways emerge: low-mass galaxies in groups/filaments grow faster, especially those undergoing starvation, mergers, and RPS. At high masses, mergers and starved galaxies show clear star formation suppression.

Conclusion: The incidence of different environmental mechanisms depends strongly on both mass and environment, with distinct evolutionary pathways emerging across mass ranges. This theoretical framework provides essential context for the MAGNET observational program to study environmental effects on nearby galaxies.
...
TL;DR: The paper presents a suite of long-duration GRMHD simulations to derive first-principles subgrid prescriptions for supermassive black hole accretion and feedback in low-Eddington hot accretion flows, revealing that BH spins remain effectively frozen during quiescent accretion phases.


<details>
  <summary>Details</summary>
Motivation: To understand how supermassive black holes couple to their host galaxies across vast spatial and temporal scales, and to develop first-principles subgrid prescriptions for cosmological simulations and semi-analytic models that capture bidirectional inflow-outflow from event horizon to Bondi scale.

Method: Used multizone framework with long-duration GRMHD simulations spanning BH spins |a*|=0-0.9 and Bondi radii RB/rg=4×10²-2×10⁶, analyzing hot accretion flows with low-Eddington ratios (f_Edd≲10⁻³) to derive time-averaged accretion rates, feedback power, and spin evolution.

Result: Derived compact analytic fits for accretion rate and feedback power relative to Bondi rate; quantified lognormal distributions of accretion rate and feedback efficiency; found spin-up parameter s(a*)≃-3.7a* with long spindown timescale ts≃12(10⁻³/f_Edd) Gyr, indicating effectively frozen BH spins during quiescent accretion.

Conclusion: BH spins remain effectively frozen during phases of quiescent accretion, and simulations reaching dynamical equilibrium across horizon-to-galaxy scales yield systematically different long-term accretion, feedback, and spin properties compared to conventional small-domain GRMHD calculations, cautioning against direct extrapolation when constructing galactic-scale subgrid models.
...
TL;DR: Analysis of radial metallicity gradients in disc galaxies using EAGLE simulations shows that alignment patterns between young stars and star-forming gas gradients reveal different evolutionary histories over ~2 Gyr.


<details>
  <summary>Details</summary>
Motivation: To assess how joint analysis of metallicity gradient alignment in young stars and star-forming gas can constrain recent evolutionary history of galaxies, using these gradients as tracers of recent galactic evolution.

Method: Used high-resolution EAGLE simulations to derive radial oxygen abundance profiles for young stars (age < 2 Gyr) and star-forming gas, measured gradients via linear fits, and classified galaxies into four groups based on slope signs (NN, NP, PP, PN).

Result: Different gradient combinations reflect distinct evolutionary paths: NN galaxies show sustained inside-out growth with high star formation efficiency; NP and PP systems indicate recent/ongoing feedback-driven disruption; PN galaxies reveal past violent events followed by gradient recovery.

Conclusion: Alignment between stellar and gas metallicity gradients provides timing information for significant evolutionary events and serves as probe of sub-grid physics when compared with observational data.
...
TL;DR: Analysis of giant molecular clouds (GMCs) in lenticular galaxy NGC 1387 reveals they follow Milky Way-like scaling relations, are mostly virialized, and show diverse angular momentum alignment patterns, challenging previous assumptions about ETG molecular clouds.


<details>
  <summary>Details</summary>
Motivation: Giant molecular clouds (GMCs) in early-type galaxies (ETGs) are poorly studied despite their importance for understanding star formation and galaxy evolution. This research aims to characterize GMC properties in the lenticular galaxy NGC 1387 to address this knowledge gap.

Method: Used high spatial resolution (0.15" or 14 pc) ALMA 12CO(2-1) line observations to identify 1285 individual GMCs. Applied modified CPROPStoo package to measure fundamental properties (radius, velocity dispersion, molecular gas mass) of each cloud.

Result: NGC 1387 GMCs follow scaling relations similar to Milky Way disc and Local Group galaxies, with most being virialized. Large, massive GMCs near galactic center have angular momenta aligned with galactic rotation, while others do not, showing diverse properties.

Conclusion: ETGs have more diversified GMC properties than previously thought. Viewing-angle dependency is suggested as a plausible explanation for this diversity, challenging conventional understanding of molecular clouds in early-type galaxies.
...
### [10] [Detection horizon for the neutrino burst from the stellar helium flash](https://arxiv.org/abs/2602.15119)
*Pablo Martínez-Miravé,Irene Tamborra,Georg Raffelt*

Main category: astro-ph.SR

TL;DR: Low-mass stars produce intense neutrino bursts during helium flashes, including a distinctive 1.7 MeV line from electron capture on ¹⁸F, but detection is challenging due to backgrounds and lack of nearby candidates.


<details>
  <summary>Details</summary>
Motivation: To investigate neutrino emission from helium flashes in low-mass stars and assess detectability in current and future neutrino observatories.

Method: Analyze nuclear processes during helium flashes, particularly alpha-capture on ¹⁴N producing ¹⁸F, and calculate neutrino emission including the 1.7 MeV line from electron capture on ¹⁸F. Evaluate detection prospects using background models for observatories like JUNO and Jinping.

Result: Helium flashes generate intense ν_e bursts (average 0.38 MeV) lasting ~1 day plus a strong 1.7 MeV neutrino line. Detection is hindered by backgrounds; Jinping could achieve 3σ detection out to ~3 pc. No suitable stellar candidates exist within 10 pc, making direct detection currently infeasible.

Conclusion: While helium flashes produce distinctive neutrino signals, asteroseismology remains the most promising tool for studying these events due to detection challenges and lack of nearby stellar candidates.
...
### [11] [The eruptive young star IRAS 21204+4913](https://arxiv.org/abs/2602.15157)
...
TL;DR: IRAS 21204+4913 experienced a ~5 magnitude brightening in October 2025, accompanied by increased polarization (~16% in I-band) and spectroscopic changes indicating a dusty wind (~300 km/s), likely due to enhanced accretion onto a young low-mass star.


<details>
  <summary>Details</summary>
Motivation: To characterize the unusual outburst of the young star IRAS 21204+4913, which brightened by ~5 magnitudes, and understand the physical mechanisms behind this event through multi-wavelength observations.

Method: Multi-technique observational approach including photometric monitoring, polarimetric measurements, and spectroscopic analysis across 0.36-0.75 μm range to study brightness changes, polarization properties, and spectral features.

Result: The star shows A-F giant/supergiant-like absorption spectra with TiO bands, ~16% polarization increase in I-band, P Cygni Hα profile indicating ~300 km/s dusty wind, and evidence of enhanced accretion rate to ≥3×10⁻⁵ M⊙/yr onto a ≤0.5 M⊙ young star.

Conclusion: The outburst is caused by increased accretion from the protoplanetary disk, with unusual features including excitation-dependent line properties, TiO emission, historical 1948 outburst, and association with T Tauri stars and Herbig-Haro objects in the region.
...
### [12] [New Insights from Revisiting the Rotation Period of the Strongly Magnetic O Star, NGC 1624-2](https://arxiv.org/abs/2602.15321)
*S. Seadrow,V. Petit,G. A. Wade,D. Bohlender,J. Maíz Apellániz,A. David-Uraz,M. Oksala,J. MacDonald*

Main category: astro-ph.SR

TL;DR: The paper analyzes the rotation period of magnetized O star NGC 1624-2, finding two equally suitable periods (153.17d and 306.56d) that better characterize spectral variations than the previously accepted 157.99d period.


<details>
  <summary>Details</summary>
Motivation: The currently accepted rotation period (157.99 days) for NGC 1624-2 does not coherently characterize variations in spectral lines of magnetospheric origin across multiple epochs, requiring re-examination of the star's rotational properties.

Method: Analyzed Lomb-Scargle periodograms using new and archival multi-instrument spectroscopic time series of Balmer H and He spectral lines to identify alternative rotation periods that better phase the spectral and magnetic time series data.

Result: Found two equally suitable periods: 153.17 ± 0.42 days and 306.56 ± 1.19 days, both of which better characterize the spectral variations. The longer period suggests a different magnetic geometry where only one magnetic pole is observed per cycle.

Conclusion: The 306.56-day period implies a magnetic geometry where both magnetic poles should be observable during a full rotational cycle, suggesting the magnetic South pole has yet to be observed and requiring additional spectropolarimetric observations for confirmation.
...
### [13] [On the dynamics, thermodynamics and fine structure of virtual erupting filaments](https://arxiv.org/abs/2602.15401)
*Dion Donné,Yuhao Zhou,Hebe Cremades,Rony Keppens*

Main category: astro-ph.SR

TL;DR: 2.5D MHD simulations reveal that magnetic reconnection drives filament eruption phases, with heating during acceleration caused by thermal conduction and compressional heating, producing EUV fine structure.


<details>
  <summary>Details</summary>
Motivation: To understand why some solar filaments erupt while others don't, investigate the heating during the acceleration phase, and explain additional fine structure in coronal mass ejections beyond the classical three-part morphology.

Method: Used open-source MPI-AMRVAC code to solve 2.5D MHD equations on a coronal domain extending to 300 Mm with adaptive mesh refinement. Applied controlled combinations of footpoint shearing and converging motions to initial magnetic arcades to produce erupting flux ropes with self-consistent prominence and coronal rain formation via thermal instability.

Result: Both non-erupting and erupting cases related to system energization. Slow-rise and impulsive phases modulated by magnetic reconnection. Transition to acceleration corresponds to increase in inflow Alfvén Mach number. Thermal conduction and compressional heating cause prominence evaporation. Nested circular fine structure in EUV images of ejected flux ropes results partly from plasmoid interactions.

Conclusion: Internal heating processes and magnetic reconnection play key roles in the early evolution of coronal mass ejections, explaining eruption dynamics, heating during acceleration, and fine structure formation.
...
### [14] [Coronal Non-Thermal and Doppler Plasma Flows Driven by Photospheric Flux in 28 Active Regions](https://arxiv.org/abs/2602.15475)
...
TL;DR: Study finds moderate correlation between photospheric magnetic flux and coronal spectral line broadening in quiescent active regions, supporting photospheric field injecting Poynting flux for coronal heating.


<details>
  <summary>Details</summary>
Motivation: To establish a direct connection between photospheric magnetic flux and coronal spectral line broadening (non-thermal velocity) as evidence for coronal heating mechanisms driven by photospheric magnetic field.

Method: Combined measurements of photospheric magnetic field from SDO/HMI and non-thermal velocity in log T~6.2 coronal plasma from Hinode/EIS for 28 active regions.

Result: Found moderate correlation between photospheric magnetic flux and spectral line broadening in quiescent active regions, consistent with photospheric field injecting upward Poynting flux into corona.

Conclusion: Results support photospheric magnetic field as driver of coronal heating, but current instrumentation cannot distinguish between MHD wave heating and magnetic field braiding heating mechanisms.
...
### [15] [A homogeneous view of asymptotic giant branch carbon stars as seen by Gaia](https://arxiv.org/abs/2602.15550)
...
TL;DR: Homogeneous spectral energy distribution analysis of 14,747 carbon stars from Gaia DR3 reveals stellar parameters, mass-loss rates, and environmental dependencies across Milky Way and Magellanic Clouds.


<details>
  <summary>Details</summary>
Motivation: Carbon stars on the asymptotic giant branch are major dust producers with high mass-loss rates, but systematic studies across different galactic environments with varying metallicities are needed to understand their properties and evolution.

Method: Used Gaia DR3 Golden Sample of carbon stars with multi-band photometry from Gaia, 2MASS, and WISE. Fitted observations with synthetic spectra from DUSTY radiative transfer code using COMARCS atmospheres. For 2,494 Mira variables, modeled multi-band light curves to derive accurate mean magnitudes.

Result: Derived effective temperatures peaking around 3150 K, mass-loss rates spanning 1e-11 to 1e-4 Msun/yr, and inner dust temperatures near 1000 K. Found correlation between variability amplitude and mass-loss rate. Environmental dependencies influenced by luminosity distributions and selection effects rather than purely intrinsic metallicity differences.

Conclusion: Provides statistically robust view of carbon stars across different metallicity environments. Selection effects limit detection of highly obscured and faint sources, but observed trends remain significant within sampled populations, offering insights into carbon star evolution and dust production.
...
### [16] [Inference of horizontal velocity fields from the induction equation in the solar atmosphere. I. Analytical and numerical solutions in 2D](https://arxiv.org/abs/2602.15561)
*H. Vila Crespo,J. M. Borrero,I. Milić,G. Vigeesh,A. Asensio Ramos*

Main category: astro-ph.SR

TL;DR: A method to retrieve height-dependent horizontal velocity fields in solar atmosphere using magnetic induction equation, validated with 1% mean error in 2D cases.


<details>
  <summary>Details</summary>
Motivation: Spectroscopic observations only provide line-of-sight velocity components (vz), while solar dynamics involve strong horizontal motions (vx, vy). Existing methods lack height dependence, providing velocities only on single planes. Modern techniques can retrieve height dependence for vz and magnetic fields, so the goal is to extend this capability to horizontal velocity fields.

Method: Discretize components of the two-dimensional magnetic induction equation via finite differences, creating an overdetermined system whose solution provides vy. Assumes B, its time variation, and vz are known (obtainable through modern Stokes inversion techniques). Tested using analytically prescribed values and 2D MHD simulations of solar surface.

Result: In idealized cases, the horizontal velocity component in a 2D domain can be successfully recovered with mean error of about 1%. The method successfully retrieves horizontal velocity field in the (y,z) plane.

Conclusion: The proposed method establishes foundation for future extensions to 3D reconstructions of horizontal velocity field in solar atmosphere, addressing current limitations in solar velocity field measurements.
...
### [17] [Morphological variations of solar granules in the presence of magnetic fields](https://arxiv.org/abs/2602.15590)
*J. I. Campos Rozo,J. Jurčák,S. M. Díaz Castillo,M. van Noort*

Main category: astro-ph.SR

TL;DR: Solar granule size and brightness decrease with increasing magnetic field strength, confirming magnetic suppression of convection; granule elongation aligns with horizontal magnetic field direction.


<details>
  <summary>Details</summary>
Motivation: To understand how solar magnetic fields influence granule dynamics (area, shape, brightness) and provide insights into plasma dynamics near the solar surface in magnetized environments.

Method: Used Swedish 1-m Solar Telescope observations of active region NOAA 11768; applied segmentation algorithm to continuum intensity images to identify granules; derived magnetic field vector and line-of-sight velocity from CRISP spectropolarimetric data; analyzed correlations between magnetic field properties and granule characteristics.

Result: Granular area decreases systematically with increasing magnetic field strength (largest granules in non-magnetic regions, mean area ~1.58 arcsec²); mean continuum intensity and granule size both decrease with stronger fields; no correlation between brightness and up-flow velocity; elongated granules appear in both magnetic/non-magnetic regions, while near-circular granules only in non-magnetic areas; granule major axes align with magnetic field azimuth where horizontal field is strong.

Conclusion: Magnetic fields suppress convective energy transport by inhibiting lateral expansion of granules; granules are highly sensitive to magnetic fields, with their morphology directly influenced by field strength and orientation, particularly horizontal components.
...
### [18] [Spectroscopic analysis and RHD modeling of the first Ca II H and H-epsilon flare spectra from DKIST/ViSP](https://arxiv.org/abs/2602.15658)
...
TL;DR: First DKIST flare observations of Ca II H and H-epsilon lines reveal discrepancies with RADYN+RH simulations, showing models underestimate Ca II H width and fail to reproduce line intensity ratios, suggesting need for improved flare heating mechanisms.


<details>
  <summary>Details</summary>
Motivation: To analyze first DKIST flare-time observations of chromospheric Ca II H and H-epsilon spectral lines at unprecedented resolution, comparing them with state-of-the-art flare simulations to test model accuracy and identify limitations.

Method: Used DKIST's Visible Spectropolarimeter (ViSP) to observe decay phase of GOES C6.7 flare SOL2022-08-19T20:31, capturing Ca II H 396.8 nm and H-epsilon 397.0 nm lines. Directly compared observations with RADYN+RH simulations including nonthermal electron beam heating and in-situ thermal conduction models.

Result: Models reproduced some properties like H-epsilon width but severely underestimated Ca II H red wing width and failed to reproduce exact relative intensity of Ca II H to H-epsilon. Models showed condensation electron densities spanning over an order of magnitude. Unlike lower-order Balmer lines, H-epsilon width was not solely related to condensation properties but also sensitive to deeper flare layers.

Conclusion: Current flare models have significant limitations in reproducing high-resolution spectral observations. Need comprehensive evaluation of flare heating mechanisms using both impulsive and decay phase data to improve model accuracy and understanding of flare physics.
...
### [19] [Hot subdwarf stars from the Hamburg Quasar Survey](https://arxiv.org/abs/2602.15692)
*Ulrich Heber,Lennard Kufleitner,Matti Dorsch,Marilyn Latour,Harry Dawson,Fabian Mattig,Stephan Geier*

Main category: astro-ph.SR

TL;DR: Analysis of 122 non-composite hot subdwarfs from HQS reveals two distinct populations: hydrogen-rich sdBs with median mass ~0.45 M☉ consistent with canonical EHB evolution, and helium-rich sdOB/sdOs with higher median mass ~0.70 M☉ supporting binary white dwarf merger origin.


<details>
  <summary>Details</summary>
Motivation: Previous studies of HQS hot subdwarfs focused mainly on sdB stars, leaving helium-rich sdOB and sdO stars poorly analyzed. The development of improved hybrid LTE/non-LTE model spectra enables precise atmospheric parameter determination and systematic study of these previously unanalyzed populations to identify evolutionary pathways.

Method: Used spectral energy distributions to identify composite-color sdB binaries, then performed detailed spectroscopic analyses of 122 non-composite subdwarfs from HQS using 2nd generation Bamberg model grids (hybrid LTE/non-LTE model spectra) to derive precise atmospheric parameters while accounting for correlations and systematic uncertainties.

Result: Hydrogen-rich sdB stars show mass distribution peaking at median 0.45 M☉ consistent with canonical EHB mass. Helium-rich sdOB/sdO stars cluster near helium main-sequence with broader mass distribution (0.48-1.05 M☉) and higher median mass of 0.70 M☉. Intermediate He-rich stars have lower mass (~0.55 M☉) than extremely He-rich stars.

Conclusion: The distinct mass distributions strongly support different formation channels: hydrogen-rich sdBs follow canonical EHB evolution, while helium-rich sdO/sdOB stars originate from binary white dwarf mergers where two helium white dwarfs merge following gravitational-wave orbital decay. Older stellar populations may produce more massive He-WD mergers.
...
### [20] [The Montreal Open Clusters and Associations (MOCA) Database: A Census of Nearby Associations, Open Clusters, and Young Substellar Objects within 500 pc of the Sun](https://arxiv.org/abs/2602.15695)
...
TL;DR: MOCAdb is a public database with Python interface providing comprehensive membership census for 10,259 associations/clusters within 500 pc, featuring updated BANYAN Σ classification tool that identified 11,535 new candidate members and updated census of age-calibrated exoplanets/substellar objects.


<details>
  <summary>Details</summary>
Motivation: To create a comprehensive, publicly accessible database for young stellar associations and open clusters within 500 pc that integrates heterogeneous literature measurements, enables characterization of substellar members, and improves membership classification tools to identify previously unrecognized members.

Method: Developed MOCAdb as a MySQL database with Python interface, compiling literature measurements (spectral types, kinematics, rotation periods, activity indices, spectral indices, photometry). Updated BANYAN Σ classification tool using Gaussian mixture models to handle heterogeneous/correlated errors and complex association shapes. Combined with Gaia DR3 data to identify new candidate members.

Result: Identified 11,535 previously unrecognized candidate members of young associations within 500 pc (mostly M dwarfs). Updated census includes 134 age-calibrated exoplanet systems (+121 TESS candidates), 455 substellar candidate members (196 newly recognized), and 101 candidate isolated planetary-mass objects (53 newly recognized). Confirmed systematic errors (~4 km/s) in Gaia DR3 radial velocities for A-type stars.

Conclusion: MOCAdb provides a comprehensive resource for studying young associations and open clusters, with improved membership classification enabling discovery of thousands of new candidate members. The database facilitates characterization of substellar objects and age-calibrated exoplanets, advancing our understanding of stellar and planetary system formation and evolution.
...
### [21] [Impact of rotation on the amplitude of acoustic modes in solar-like stars: Insights from hydrodynamical simulations](https://arxiv.org/abs/2602.15735)
*Arthur Le Saux,Leïla Bessila,Stéphane Mathis*

Main category: astro-ph.SR

TL;DR: Rotation reduces acoustic mode amplitudes and increases damping rates in solar-like stars, explaining why rapidly rotating stars show fewer detectable oscillations in Kepler observations.


<details>
  <summary>Details</summary>
Motivation: To test the theoretical prediction by Bessila et al. (2025) that rotation inhibits convective motions and reduces power for stochastic mode excitation, explaining why many rapidly rotating solar-like stars show no detectable acoustic modes in Kepler observations.

Method: Performed 2.5D simulations with longitudinal symmetry using the MUSIC code, spanning rotation rates from 0 to 8 solar rotation rates (Ω⊙), employing fully compressible hydrodynamical simulations of a solar-like star.

Result: Found clear systematic decline of acoustic mode amplitudes with increasing rotation rate, with enhanced damping rates in most rapidly rotating models, demonstrating combined reduction in excitation and increase in damping with rotation.

Conclusion: Rotation significantly modifies oscillation properties by reducing excitation and increasing damping, providing physical explanation for decreased mode detectability in rapidly rotating solar-like stars, necessitating consideration of rotation in asteroseismic interpretation.
